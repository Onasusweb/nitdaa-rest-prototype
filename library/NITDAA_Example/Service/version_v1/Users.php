...
class NITDAA_API_Service_Users extends Api_Service_IService {
    ...
    public function all($params, $config) {
        ...
        // Connect to mysql
        $link = mysqli_connect(
                $config['db_host'], /* The host to connect to */ $config['db_user'], /* The user to connect as */ $config['db_pass'], /* The password to use */ $config['db_name']);     /* The default database to query */
